...
/*
Analice, compile y ejecute el programa sem03.c . Observe la salida por consola.
- ¿Qué sucede en el progama?

El programa se bloquea ya que el semáforo se inicia en 0, luego se incrementa 5 veces y se intenta de crementar 6 veces, con lo cual, cuando se intenta decrementar la última vez, se bloque. Si en cambio inicializamos el semáforo en 1 o lo incrementamos 6 veces el programa termina normalmente. 
*/
